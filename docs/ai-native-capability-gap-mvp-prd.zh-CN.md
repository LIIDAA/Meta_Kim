...
- 本地已有但 `origin/main` 仍未包含：Cursor live harness blocked contract、runtime evidence aggregator / writeback approval、P-015 到 P-021 编排质量轨、P-022 产品面板数据合同、P-012 / P-013 / P-014 / P-023 用户交付轨、P-006 / P-007 全 meta agents shard live evidence、以及本 PRD v0.19 的状态更新。
...
|---|---|---|---|---|
| Runtime evidence | P-006、P-007、P-024 | meta-conductor | P-006 / P-007 已测通；P-024 依赖 Cursor Agent CLI 环境 | P-024 没有可用 CLI 前只能保留 blocked，不可伪造 pass |
